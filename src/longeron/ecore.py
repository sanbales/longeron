...
The pragmatic dataclasses in :mod:`longeron.model` are shaped like the textual
...
# NOTE: kept at the historical "sysml2-experiments" seed on purpose -- the
# package was renamed to longeron in 0.3.0, but changing the namespace would
# change every derived element @id across releases.
