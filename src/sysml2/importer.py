"""Rebuild models from their JSON export (:func:`sysml2.export.to_dict`).
...
def from_dict(data: dict[str, Any]) -> M.Element:
    """Reconstruct a model element from :func:`sysml2.export.to_dict` data."""
...
def from_json(text: str) -> M.Model:
    ...
    fresh :class:`~sysml2.model.Model` so the result is always executable.
    """
