...
The projection turns a :class:`~sysml2.model.Model` into an
...
:mod:`sysml2.ecore` / :mod:`sysml2.api` emit as ``@type`` in Systems
...
Scope mirrors the :mod:`sysml2.ecore` prototype: structure, names, flags,
...
def to_graph(
    ...
    *,
    ...
    :class:`~sysml2.interpreter.Interpreter` per owning definition and
