...
MUTATIONS: list[Mutation] = [
    ...
    # -- known gaps, pinned in tests/test_rejection.py since phase 1
    Mutation(
        ...
        pinned_case="state-in-attribute-def",
    ),
    Mutation(
        ...
        requires=("part-attr",),
        pinned_case="attribute-typed-by-part-def",
    ),
    Mutation(
        ...
        pinned_case="part-typed-by-attribute-def",
    ),
    Mutation(
        "typed-by-package",
        ...
        requires=("typed-part",),
        pinned_case="part-typed-by-package",
    ),
    Mutation(
        "subsets-a-package",
        ...
        requires=("typed-part",),
        pinned_case="subsetting-a-package",
    ),
    Mutation(
        ...
        _mut_real_bound,
        requires=("typed-part",),
        pinned_case="real-multiplicity-bound",
    ),
    Mutation(
        ...
        pinned_case="variant-outside-variation",
    ),
    Mutation(
        ...
        _mut_second_entry,
        requires=("state-machine",),
        pinned_case="two-entry-transitions",
    ),
    # -- NEW gaps, found by this tier (pinned in tests/test_rejection.py)
    Mutation(
        ...
        requires=("part-attr",),
        pinned_case="redefinition-of-sibling-feature",
    ),
    Mutation(
        ...
        pinned_case="package-level-redefinition",
    ),
    Mutation(
        ...
        requires=("connect",),
        pinned_case="connector-end-is-a-definition",
    ),
    Mutation(
        "second-subject",
        ...
        pinned_case="two-subjects-in-requirement",
    ),
    Mutation(
        ...
        _mut_second_return,
        requires=("calc",),
        pinned_case="two-return-parameters",
    ),
    Mutation(
        ...
        pinned_case="attribute-def-specializes-part-def",
    ),
    Mutation(
        ...
        pinned_case="action-def-specializes-part-def",
    ),
    Mutation(
    ...
    Mutation(
        ...
        _mut_dangling_bound,
        requires=("typed-part",),
        pinned_case="unresolved-multiplicity-bound",
    ),
    Mutation(
        ...
        pinned_case="succession-end-unresolved",
    ),
    Mutation(
        "perform-of-ghost",
        ...
        _mut_perform_ghost,
        requires=("part-def",),
        pinned_case="perform-target-unresolved",
    ),
]
